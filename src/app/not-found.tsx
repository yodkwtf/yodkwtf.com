...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-accent-500/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="relative text-center max-w-lg mx-auto space-y-8">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="font-display text-[10rem] md:text-[14rem] leading-none text-transparent select-none"
        ...
        >
          ...
          <p className="text-ink-muted leading-relaxed">
            This page doesn&apos;t exist — or it did and I deleted it. Either way,
          ...
          <div className="space-y-1">
            ...
            {LINKS.map((l) => (
              <div key={l.href}>
                ...
                <Link href={l.href} className="text-accent-400 hover:text-accent-300 transition-colors underline-anim">
                  {l.href}
                </Link>
              </div>
            ))}
