...
export function HeroSection() {
  return (
    <section className="relative min-h-[calc(100vh-80px)] flex items-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 w-full">
        <div className="max-w-3xl space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1, ease: [0.16, 1, 0.3, 1] }} className="space-y-2">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
            className="text-ink-muted text-lg leading-relaxed max-w-xl">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3, ease: [0.16, 1, 0.3, 1] }}
        ...
        <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.5, ease: [0.16, 1, 0.3, 1] }}
          className="absolute right-6 top-1/2 -translate-y-1/2 hidden xl:block">
          <div className="glass rounded-xl p-5 font-mono text-xs leading-6 shadow-xl glow-accent-sm max-w-xs">
            ...
            <div className="space-y-0.5">
              ...
              <div className="pl-4"><span className="text-ink-muted">name:</span> <span className="text-amber-400/80">&quot;Alex Rivera&quot;</span><span className="text-ink-muted">,</span></div>
              <div className="pl-4"><span className="text-ink-muted">role:</span> <span className="text-amber-400/80">&quot;Full-Stack&quot;</span><span className="text-ink-muted">,</span></div>
              <div className="pl-4"><span className="text-ink-muted">stack:</span> <span className="text-accent-300">[</span></div>
              <div className="pl-8"><span className="text-amber-400/80">&quot;Next.js&quot;</span><span className="text-ink-muted">,</span></div>
              <div className="pl-8"><span className="text-amber-400/80">&quot;TypeScript&quot;</span><span className="text-ink-muted">,</span></div>
              <div className="pl-8"><span className="text-amber-400/80">&quot;Node.js&quot;</span><span className="text-ink-muted">,</span></div>
